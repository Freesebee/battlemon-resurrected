...
export class CreatePokemonComponent implements OnInit {
  ...
  createForm = this.formBuilder.group({
    ...
    type: ['',[Validators.required,Validators.minLength(1),Validators.maxLength(10)]],
    dmg: ['',[Validators.required,Validators.minLength(1),Validators.maxLength(10)]],
    hp: ['',[Validators.required,Validators.minLength(1),Validators.maxLength(10)]],
    crit_chance: ['',[Validators.required,Validators.minLength(1),Validators.maxLength(3),Validators.min(0),Validators.max(100)]],
  });
